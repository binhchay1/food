...
<form id="wprm-user-ratings-modal-stars-form" onsubmit="window.WPRecipeMaker.userRatingModal.submit( this ); return false;">
	...
	<div class="wprm-user-rating-modal-comment-meta">
		...
		<div class="wprm-user-rating-modal-field">
			<label><?php _e( 'Name' ); ?><?php if ( WPRM_Settings::get( 'user_ratings_require_name' ) ) { echo ' *'; } ?></label>
			<input type="text" name="wprm-user-rating-name" value="<?php echo esc_attr( isset( $current_commenter['comment_author'] ) ? $current_commenter['comment_author'] : '' ); ?>" placeholder="<?php echo esc_attr( WPRM_Settings::get( 'user_ratings_modal_name_placeholder' ) ); ?>" />
		</div>
		<div class="wprm-user-rating-modal-field">
			<label><?php _e( 'Email' ); ?><?php if ( WPRM_Settings::get( 'user_ratings_require_email' ) ) { echo ' *'; } ?></label>
			<input type="email" name="wprm-user-rating-email" value="<?php echo esc_attr( isset( $current_commenter['comment_author'] ) ? $current_commenter['comment_author_email'] : '' ); ?>" placeholder="<?php echo esc_attr( WPRM_Settings::get( 'user_ratings_modal_email_placeholder' ) ); ?>" />
		</div>
	</div>
