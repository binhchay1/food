		...
		<div class="current-recipe">
			<main
				...
				<div class="layout__item title svelte-1r658j4">
					<h1 class="svelte-1muv3s8">Pumpkin Marble Cheesecake</h1>
				</div>
				<div class="layout__item rating-badge svelte-1r658j4">
					<div class="rating-batch svelte-1natcrv">
						<div class="rating">
							<a
								href="#reviews"
								aria-label="Recipe rated 4.86 stars. 23 ratings">
						...
						<div class="badge badge--standard svelte-1qfe6sy">
							<div
								class="badge__contents button button--outline-ribbon svelte-1qfe6sy">
								<a
									data-track="Community Pick"
									href="/recipe/all/popular"
									class="caption svelte-1qfe6sy">
									<div class="text">
										<div class="label"></div>
				...
				<div class="layout__item ad-sponsor ad svelte-1r658j4">
					<div class="ad">
						<div
							class="ad__ad ad__ad--logo"
							data-slot-type="dfp_logo"></div>
					</div>
				</div>
						...
						<div class="author svelte-176rmbi">
							<div class="avatar svelte-176rmbi">
								<a
									...
									class="svelte-176rmbi">
									<img
										alt=""
										width="60"
										height="60"
										src="https://img.sndimg.com/food/image/upload/v1/gk-static/gk/img/avatar/pop.png"
										class="svelte-176rmbi" />
								</a>
							</div>
							<div class="byline svelte-176rmbi">
								...
								<a
									href="https://www.food.com/user/9690"
									class="svelte-176rmbi">Cheryl E</a>
							</div>
						</div>
				...
				<div class="layout__item actions svelte-1r658j4">
					<div class="action svelte-1r658j4">
						<button
							class="button button--growing svelte-1cpm2yv"
							title="Save">
							<svg
								width="18"
								height="24"
					...
					<a
						download
						href="/recipe/pumpkin-marble-cheesecake-12080/as-image"
						class="action button button--growing svelte-1r658j4"
						title="Download">
						<svg
							width="25"
							height="24"
							...
							aria-hidden="true">
							<path
								d="M1.25 22.9989C1.25 22.446 1.69858 21.9978 2.25193 21.9978H22.3251C22.8785 21.9978 23.327 22.446 23.327 22.9989C23.327 23.5518 22.8785 24 22.3251 24H2.25193C1.69858 24 1.25 23.5518 1.25 22.9989Z"
								fill="currentColor"></path>
							<path
								d="M13.2962 1.0011C13.2962 0.448207 12.8476 4.83352e-08 12.2943 0C11.7409 -4.83352e-08 11.2923 0.448207 11.2923 1.0011L11.3021 14.5975L6.98822 10.2873C6.59694 9.89631 5.96255 9.8963 5.57127 10.2873C5.18 10.6782 5.18 11.3121 5.57127 11.703L11.5811 17.7079C11.9724 18.0988 12.6068 18.0988 12.9981 17.7079L19.0073 11.7037C19.3986 11.3127 19.3986 10.6789 19.0073 10.2879C18.616 9.89696 17.9816 9.89696 17.5903 10.2879L13.3059 14.5688L13.2962 1.0011Z"
								fill="currentColor"></path>
						</svg>
				...
				<div class="layout__item i-made-this svelte-1r658j4">
					<button
						class="action action--i-made-this button--primary svelte-1102v48"
						aria-haspopup="dialog"
						aria-expanded="false"
						aria-controls="i-made-this-modal">
						<svg
							width="24"
							height="24"
							viewBox="0 0 24 24"
							...
							<path
								fill-rule="evenodd"
								clip-rule="evenodd"
								d="M17.6 12.4C17.6 9.30721 15.0928 6.8 12 6.8C8.90721 6.8 6.4 9.30721 6.4 12.4C6.4 15.4928 8.90721 18 12 18C15.0928 18 17.6 15.4928 17.6 12.4ZM8 12.4C8 10.1909 9.79086 8.4 12 8.4C14.2091 8.4 16 10.1909 16 12.4C16 14.6091 14.2091 16.4 12 16.4C9.79086 16.4 8 14.6091 8 12.4Z"
								fill="currentColor"></path>
							<path
								d="M20 10C20.4418 10 20.8 9.64183 20.8 9.2C20.8 8.75817 20.4418 8.4 20 8.4C19.5582 8.4 19.2 8.75817 19.2 9.2C19.2 9.64183 19.5582 10 20 10Z"
								fill="currentColor"></path>
							<path
								fill-rule="evenodd"
								clip-rule="evenodd"
